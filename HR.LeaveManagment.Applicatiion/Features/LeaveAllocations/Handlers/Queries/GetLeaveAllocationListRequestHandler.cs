...
using HR.LeaveManagment.Applicatiion.Features.LeaveAllocations.Requests.Queries;
using MediatR;
using System;
...
namespace HR.LeaveManagment.Applicatiion.Features.LeaveAllocations.Handlers.Queries
{
